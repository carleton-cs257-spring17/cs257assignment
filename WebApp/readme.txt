...
3. It might take a few seconds for events to show up. It does not often act like that, but there is a fairly high chance that it would happen. Please use shift+command+r to refresh the page if in Chrome.