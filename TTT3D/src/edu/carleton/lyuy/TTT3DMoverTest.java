...
/**
 * Created by yanhanlyu on 01/04/2017. We overwrite equals method in TTT3DMove class, so when
 * assertEquals compare two sets, they can compare two TTT3DMove objects using the new equals method.
